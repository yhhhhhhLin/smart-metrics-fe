...
import { projectManagerIndexViewRoutes, projectManagerRootPath } from "../../router";

const routes = reactive(projectManagerIndexViewRoutes);
...
const getFullPath = (path: string) => {
  return projectManagerRootPath + '/' + path;
};
</script>
